...
# data process
if mode == 'train':
    train_data_o = json.load(open(data_path+'Anet_object_classifier_train_30.json'))
    data = []
    ...
    test_data_o = json.load(open(data_path+'Anet_object_classifier_' +dataset+'_30.json'))
