...
pairs_te = json.load(open('./results/model_epoch5_test.json'))
pairs_tr = json.load(open('./results/model_epoch5_train.json'))
pairs_va = json.load(open('./results/model_epoch5_val.json'))
