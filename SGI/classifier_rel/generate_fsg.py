...
#     nlp = spacy.load("en_core_web_lg")
    ...
    if mode == "train":
        graph_input = json.load(open("../Charades/Charades_v1_train_graph_b.json"))
        rel_input = json.load(open("results/model_epoch4_train.json"))
        att_input = json.load(open("../classifier_att/results/model_epoch4_train.json"))
        text_out = open('../Charades/Charades_v1_train_graph_f.json','w')
    elif mode == "test":
        graph_input = json.load(open("../Charades/Charades_v1_test_graph_b.json"))
        rel_input = json.load(open("results/model_epoch4_test.json"))
        att_input = json.load(open("../classifier_att/results/model_epoch4_test.json"))
        text_out = open('../Charades/Charades_v1_test_graph_f.json','w')
    else:
        graph_input = json.load(open("../Charades/Charades_v1_val_graph_b.json"))
        rel_input = json.load(open("results/model_epoch4_val.json"))
        att_input = json.load(open("../classifier_att/results/model_epoch4_val.json"))
        text_out = open('../Charades/Charades_v1_val_graph_f.json','w')
